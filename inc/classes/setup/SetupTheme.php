...
class SetupTheme {
	...
	public function __construct() {
		...
		add_action( 'wp_head', array( $this, 'gtag' ) );
		add_action( 'wp_body_open', array( $this, 'gtag_fallback' ) );
	}
	...
	public function gtag() {
		?>
			...
			})(window, document, 'script', 'dataLayer', 'GTM-NBN8G4Z');
			</script>
